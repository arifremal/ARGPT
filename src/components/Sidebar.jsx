...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    ...
    >
      ...
      {/* Recent Chats - This section will grow and scroll if needed */}
      ...
      {/* Community Images - This will stick to the bottom */}
      <div
        onClick={() => {
      ...
      {/* Credits - This will stick to the bottom */}
      <div
        onClick={() => {
      ...
      >
        ...
        <div className="flex flex-col text-sm">
          ...
          <p className="text-xs text-gray-400">Purchase credits to use ARGPT</p>
        </div>
      </div>
      {/* Darmode toggle - This will stick to the bottom */}
